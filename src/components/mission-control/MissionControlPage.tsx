...
import { RAD2DEG, propagateAt, normalizeLonRad } from '../../utils/orbitMath'
...
import { PANEL, GHOST_BTN, CHIP } from './mcStyles'
...
import AccessibleMissionList from './AccessibleMissionList'
import OrbitLoadingState from './OrbitLoadingState'
import OrbitErrorState from './OrbitErrorState'
      ...
      <div className="order-1 relative h-screen min-w-0 flex-1 overflow-hidden bg-[#050b1f] text-white">
        ...
        <div className="pointer-events-none absolute bottom-4 left-4 z-30 flex w-[248px] flex-col">
          ...
          <button
            ...
            className={`mc-liquid-glass pointer-events-auto flex w-full shrink-0 items-center gap-2 rounded-lg px-3 py-2 text-[12px] font-bold uppercase tracking-[0.14em] text-white/80 transition-colors hover:text-white ${

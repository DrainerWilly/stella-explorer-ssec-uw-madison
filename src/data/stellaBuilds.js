...
export const INSTRUMENTS = [
  {
    ...
    photo: 'assets/stella/stella-1-2.webp',
    photoAlt: 'NASA photo of the white 3D-printed STELLA-1.2 with its touchscreen and rotary knob',
    accent: '#59b95f',
  ...
  },
  {
    id: 'aa1',
    name: 'STELLA-AA1',
    fullName: 'STELLA-1.2 · Air Analyzer module',
    group: 'platform',
    chassis: 'platform',
    buildTag: 'Base + snap-on module',
    tagline: 'A pocket air-quality station for CO₂, methane, and particulates.',
    photo: 'assets/stella/aa1-module.png',
    photoAlt: 'NASA photo of the STELLA-AA1 air analyzer module board with sensors',
    accent: '#5aa7dc',
    measures: ['CO₂ concentration', 'Methane', 'Particulates (PM1 / 2.5 / 10)', 'Humidity · air temp · pressure'],
    science:
      'Log the air your community breathes: carbon dioxide, methane, and particle pollution, all timestamped and GPS-located for real atmospheric science.',
    specs: ['ESP32-S3', 'SCD-40 CO₂', 'MQ-4 methane', 'PMSA003I particulates', 'MCP9808 + BME280', 'GPS + SD'],
    sourceUrl: 'https://science.gsfc.nasa.gov/stella/instruments/stella-1-2/stella-aa1-module/',
    moduleParts: [
      {
        id: 'scd40',
        name: 'SCD-40 CO₂ sensor',
        kind: 'Gas sensor',
        cost: 45,
        icon: 'co2',
        callout: 'Start with the greenhouse gas everyone tracks: the photoacoustic carbon-dioxide sensor.',
        note: 'Reads CO₂ in parts-per-million. Outdoor air is about 420 ppm; your breath is around 40,000.',
      },
      {
        id: 'mq4',
        ...
        cost: 5,
        icon: 'flame',
        callout: 'Methane traps roughly 80 times more heat than CO₂ short-term. Add the sensor that sniffs it out.',
        note: 'A heated tin-oxide element whose resistance drops when CH₄ is present.',
      },
      {
        id: 'pmsa',
        name: 'PMSA003I particulate sensor',
        kind: 'Particle counter',
        cost: 45,
        icon: 'dust',
        callout: 'Smoke and dust are what you can see, and breathe. Add the laser particle counter.',
        note: 'Counts particles by laser scattering: PM1, PM2.5, and PM10 size bins.',
      },
      {
        id: 'mcp9808',
        name: 'MCP9808 + BME280 met sensors',
        kind: 'Weather sensors',
        cost: 20,
        icon: 'thermo',
        callout: 'Gas readings drift with weather. Add the precision temperature, humidity, and pressure pair.',
        note: '±0.25 °C temperature plus barometric pressure and relative humidity.',
      },
      {
        id: 'magnets',
        name: 'Magnetic connector pair',
        ...
        icon: 'magnet',
        callout: 'Modules snap on and off the base. Add the magnetic connectors that carry power and data.',
        note: 'Swap to the RS module tomorrow. Same base, different science.',
      },
    ],
  },
  {
    id: 'proto',
    name: 'STELLA-Proto',
    fullName: 'STELLA-1.2 · Prototyping module',
    group: 'platform',
    chassis: 'platform',
    buildTag: 'Base + snap-on module',
    tagline: 'A blank canvas for inventing your own instrument.',
    photo: 'assets/stella/prototyping-module.png',
    photoAlt: 'NASA photo of the STELLA-1.2 prototyping module with empty mounting deck',
    accent: '#e0a94e',
    measures: ['Any Qwiic / I²C sensor', 'Tape & Velcro mounting deck', 'Your idea here'],
    science:
      'NASA left this one intentionally empty: a powered, GPS-stamped, data-logging deck for whatever sensor your experiment needs.',
    specs: ['ESP32-S3', 'Qwiic / I²C bus', 'Tape & Velcro deck', 'GPS + SD', '5 V boost rail'],
    sourceUrl: 'https://science.gsfc.nasa.gov/stella/instruments/stella-1-2/stella-prototyping-module/',
    moduleParts: [
      {
        id: 'deck',
        name: 'Prototyping deck board',
        kind: 'Mounting deck',
        cost: 7,
        icon: 'board',
        callout: 'Every invention needs a workbench. Add the blank deck that commercial sensors mount onto.',
        note: 'Sensors attach with tape or Velcro, so nothing is permanent.',
      },
      {
        id: 'qwiic',
        name: 'Qwiic cable kit',
        kind: 'Connectors',
        cost: 5,
        icon: 'cable',
        callout: 'No soldering required for new ideas. Add the plug-together I²C cables.',
        note: 'Daisy-chain almost any Qwiic-compatible sensor straight into the bus.',
      },
      {
        id: 'magnets',
        name: 'Magnetic connector pair',
        ...
        icon: 'magnet',
        callout: 'Modules snap on and off the base. Add the magnetic connectors that carry power and data.',
        note: 'Your prototype rides the same rails as NASA’s own modules.',
      },
    ],
  },

  // ---- fixed-configuration spectral instruments -----------------------------
  {
    id: 'q2',
    name: 'STELLA-Q2',
    ...
    photo: 'assets/stella/stella-q2.jpg',
    photoAlt: 'NASA photo of the bright green STELLA-Q2 faceplate with its OLED window and MODE button',
    accent: '#4cae3d',
  ...
  },
  {
    ...
    photo: 'assets/stella/stella-1-1.jpg',
    photoAlt: 'NASA diagram of STELLA-1.1 internals: spectral sensors, thermal sensor, SD card, clock, and battery',
    accent: '#3fa7a0',
...
export const COMING_SOON = {
  name: 'STELLA-Lab_Spec',
  tagline: 'Excitation spectrometer, coming soon from NASA.',
}
